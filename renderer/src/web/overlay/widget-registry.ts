...
import PriceCheckInstantWindow from "@/web/price-check/PriceCheckInstantWindow.vue";
...
registry.widgets.push(PriceCheckInstantWindow as unknown as WidgetComponent);
